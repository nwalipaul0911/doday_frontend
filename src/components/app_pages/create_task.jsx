...
const CreateTask = () => {
  ...
  const path = location.charAt(5)=='t'?'/app/tasks':`${location.slice(0,-12)}`;
  ...
  return (
    ...
    <div className="backdrop" onClick={()=>navigate(path)}></div>
      ...
      >
        <div className="d-flex justify-content-end"><i className={`fa-solid fa-xmark toggler ${text_color}`} onClick={()=>navigate(path)}></i></div>
